...
[(Reference: Cochrane Handbook)](http://www.cochrane-handbook.org/){target="_blank"}
...
**Clinical Forest Plot:** A step-by-step guide to interpreting a forest plot from a typical clinical meta-analysis is available [here](https://s4be.cochrane.org/blog/2016/07/11/tutorial-read-forest-plot/){target="_blank"}. 
