...
It may help to use a [GRADE Approach](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0187271) to rate the certainty of the evidence of preclinical animal studies, in the context of therapuetic interventions. 
...
A checklist can be found [here](http://www.prisma-statement.org/PRISMAStatement/Checklist)

We recommend using the PRISMA Flowchart to visualise the studies in your systematic review process. The PRISMA Flowchart template can be [found here.](http://prisma-statement.org/prismastatement/flowdiagram)
