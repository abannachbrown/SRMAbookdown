...
SYRCLE (SYstematic Review Centre for Laboratory animal Experimentation) have developed a protocol template tailored to the preparation, registration and publication of systematic reviews of animal intervention studies. [See the template and publication here](https://onlinelibrary.wiley.com/doi/epdf/10.1002/ebm2.7). 


It may also be useful to look through examples from the [SyRF Protocol Registry](http://syrf.org.uk/protocols/) while you formulate your protocol. Look at the Protocol Registry to check that no systematic reviews on your research question are currently underway. 
...
For more information on registering at PROSPERO, see their [website here](https://www.crd.york.ac.uk/prospero/).
