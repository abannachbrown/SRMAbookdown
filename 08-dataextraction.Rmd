...
We recommend using [SyRF](http://syrf.org.uk/) the Systematic Review Facility to extract and store your data. It is a free-to-use online platform where you can create custom data extraction forms for your review. Flexible questions types and question settings, as well as online format allow for easy data extraction for you and your review team to simultaneous extract data from included papers. For more information see the [SyRF Website](http://syrf.org.uk/) and the [SyRF Help Guide](https://assets.syrf.org.uk/guides/SyRF_User_Guide.pdf) to set up your free review project. 
