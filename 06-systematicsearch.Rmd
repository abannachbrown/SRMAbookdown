...
1. Use your reference manager. Guides for retrieving from [Endnote](https://subjectguides.library.american.edu/c.php?g=479020&p=3324236) and [Zotero](https://www.zotero.org/support/locate) can be found at the respective links. 

N.B. Remember to add your Institutional Log-in information to the settings or preferences of the reference manager, e.g. [EzProxy](https://ezproxy-db.appspot.com/) information or [OpenURL](https://www.zotero.org/support/locate/openurl_resolvers) information, so you can more easily find the full texts that your institutional library has access to. 
